...
And then inside the dotfiles directory remove the README and screenshot files and run: <br> (you will probably need to remove ~/.bashrc and any other already existing files) <br>
```
stow -t ~ *
```
